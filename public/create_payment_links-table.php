...
if (isset($_POST['mobile']) && isset($_POST['btnAdd'])) {
    ...
    if ($result == 1) {
        header("Location: create_payment_links.php?status=success");
        exit();
    } else {
...
<section class="content-header">
    <h1>Create Payment Links /<small><a href="home.php"><i class="fa fa-home"></i> Home</a></small></h1>
    <?php 
    if (isset($_GET['status']) && $_GET['status'] == 'success') {
        echo "<section id='success-message' class='content-header'>
                <span class='label label-success'>Payment Links Created Successfully</span>
              </section>";
    } else {
