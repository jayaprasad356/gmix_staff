...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <link rel="icon" type="image/ico" href="dist/img/gmix.png">
    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="home.php" class="logo">
                ...
                <span class="logo-mini">
                     <img src="dist/img/gmix.png" height="40px" width="40px" style="border-radius:15px;" alt="">
                </span>
        ...
        <aside class="main-sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="treeview">
                    <a href="home.php">
                        <i class="fa fa-home" class="active"></i> <span>Dashboard</span>
                    </a>
                </li>
                <li class="treeview">
